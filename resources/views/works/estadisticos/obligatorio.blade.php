...
@section('header')
    <h1>
        Reporte alor Servicios de Parqueadero
    </h1>
    <small>Informe</small>

    <ol class="breadcrumb">
      <li><a href="{{route('home')}}"><i class="fa fa-dashboard">  Inicio</i></a></li>
      <li class="active">Reporte valor Servicios de Parqueadero </li>
    </0l>
...
@section('content')
  ...
  <div class="box box-primary">
    <div class="box-header">
        <h3 class="box-title">Reporte valor Servicios de Parqueadero</h3>
