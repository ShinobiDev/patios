...
@section('header')
    <h1>
        Reporte de Permanencia Obligatoria
    </h1>
    <small>Informe</small>

    <ol class="breadcrumb">
      <li><a href="{{route('home')}}"><i class="fa fa-dashboard">  Inicio</i></a></li>
      <li class="active">Reporte Permanencia Obligatoria </li>
    </0l>
...
@section('content')
  ...
  <div class="box box-primary">
    <div class="box-header">
        <h3 class="box-title">Reporte Permanencia Obligatoria</h3>
    ...
    <div class="box-body">
        <table id="salida-table" class="table table-bordered table-striped">
          <thead>
            <tr>
              <th>Fecha Ingreso</th>
              <th>Encima y debajo tiempo permanencia</th>
              <th>Días Inmovilización</th>
              <th>Placa</th>
              <th>Causal</th>
              <th>N. Infracción</th>
            </tr>
          ...
          <tbody>
            @foreach ($vista as $vistas)
              <tr>
                ...
                {{ $suma = -$vistas->grado + $dias->diffInDays($vistas->created_at)}}</th>
                <th>{{$inmo = $dias->diffInDays($vistas->created_at)}}</th>
                <th>{{$vistas->placa}}</th>
