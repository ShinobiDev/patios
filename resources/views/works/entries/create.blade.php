        ...
        <div class="col-md-6">
            ...
            <div class="box box-primary">
              ...
              <div class="box-header with-border">
                <h3><i class="fa fa-pencil"></i>  Crear Ingreso De Vehículo</h3>
              </div>
                  ...
                  <form method="POST" action="{{route('entries.store')}}">
                    {{csrf_field()}}
                        <div class="form-group">
                            ...
                            @if(isset($_GET['p']))
                              <input type="text" name="placa" value="{{$_GET['p']}}" maxlength="6" class="form-control" onkeyup="mayus(this);" readonly>
                              <input type="hidden" name="id" value="{{$_GET['i']}}" maxlength="6" class="form-control" onkeyup="mayus(this);">
                            @else
                              <input type="text" name="placa" value="{{old('placa')}}" maxlength="6" class="form-control" onkeyup="mayus(this);">
                              <input type="hidden" name="id" value="{{old('placa')}}" maxlength="6" class="form-control" onkeyup="mayus(this);">
                            @endif
                        ...
                        <div class="form-group">
                            ...
                            <input type="direccion" name="direccion" value="{{old('direccion')}}" class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <section class="hidden" id="causa">
                          ...
                          <div class="form-group">
                              ...
                              <select class="form-control select2" name="infraccion_id" id="infracion">
